...
class RulesText {
    ...
    var forthTextPartOne: String = "Что мы делаем, когда используем \"метод исключения\" в игре Судоку? Вот пример. В этой сетке Судоку (показано ниже) в левом вертикальном столбце (выделен синим) отсутствуют только нескольких чисел: 1, 5 и 6."
